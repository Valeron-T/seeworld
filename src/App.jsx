...
const App = () => (
  <div className="">
    ...
    <div className='text-white w-full min-h-[100vh] overflow-hidden bg-cover bg-[url("./assets/images/bayhd.jpg")] bg-left flex flex-col pb-4'>
      ...
      <div className='flex flex-row flex-1 pb-4'>
        <div className="flex flex-col ss:px-16 px-4 justify-center items-start md:w-[45%] ss:w-[50%] w-[90%] text-left mr-4">
          ...
          <h1 className='xl:text-[8rem] ss:text-[4rem] text-[2.75rem] font-worksans font-semibold leading-[1] py-4'>Elafonissi Beach</h1>
          ...
          <div className="bg-white/20 shadow-xl rounded-xl py-4 backdrop-blur-md flex flex-row min-w-[100%] ss:px-4">
    ...
    <div className="flex flex-col">
      <h1>Sec 2</h1>
      <h1 className='font-worksans font-extralight'>Sec 2</h1>
    </div>
  </div>
