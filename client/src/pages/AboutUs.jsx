  ...
  return (
    <div className='min-h-[100vh] bg-gray-700'>
      <div className={`sm:px-16 px-6 flex flex-col justify-center items-center z-30 w-full`}>
        ...
        <h1 className='font-blacksword animate__animated animate__fadeInUp xl:p-16 xl:text-8xl lg:p-8 lg:text-6xl sm:text-4xl text-2xl text-white p-4'>About Us</h1>
        <p className='text-white animate__animated animate__fadeInUp font-poppins xl:p-16 xl:text-6xl lg:p-8 lg:text-4xl sm:text-2xl p-4 text-center'>
