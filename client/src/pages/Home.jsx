        ...
        <div>
            ...
            <section class="bg-white dark:bg-gray-900 text-center">
                <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div class="">
                        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Pilgrimage to The Holy Land</h2>
                        <p class="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400">Embark on a spritual journey across Jordon, Israel, Palestine and Egypt over the course of 13 days (11 Nights Stay) at attractive rates !</p>
                        <div class="flex flex-col space-y-4 sm:flex-row sm:block sm:space-y-0 sm:space-x-4">
                            ...
                            <a href="https://seeworlddestinations.com" target = "_blank" class="inline-flex items-center justify-center px-4 py-2.5 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
